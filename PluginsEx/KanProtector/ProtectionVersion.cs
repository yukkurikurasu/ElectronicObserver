...
namespace KanProtector
{
    public class ProtectionVersionManager
    {
        ...
        public List<ProtectionVersion> GetVersionUpdates(int LastVer)
        {
            return VersionList.Values.Where(e => e.VersionID > LastVer).ToList();
        }
        ...
        static ProtectionVersion Version0()
        {
            ...
            version.IdentifiedEquipments = new int[] { };
            return version;
        }

        static ProtectionVersion Version1()
        {
            ProtectionVersion version = new ProtectionVersion();
            version.VersionID = 1;
            version.MaxIndentifiedEquipmentID = 164;
